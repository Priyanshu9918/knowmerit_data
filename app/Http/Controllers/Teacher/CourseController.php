...
class CourseController extends Controller
{
    ...
    {
        $id = $request->id;
        return view('front.teacher.add-lession',compact('id'));
    }
    public function edit(Request $request)
    {
        $id = $request->id;
        $course = DB::table('courses')->where('id',$id)->first();
        return view('front.teacher.edit-chapter',compact('id','course'));
    }
    ...
    public function create(Request $request)
    {
        ...
        try{
            ...
            DB::table('assign_courses')->insert($data1);
    ...
    public function c_details1(Request $request)
    {
        ...
        $st_id = $request->st_id;
        $t_courses = DB::table('courses')->where('id',$id)->first();
        return view('front.teacher.course-details',compact('t_courses','st_id'));
    }
    ...
    public function delcourse(Request $request){
        ...
        DB::table('assign_courses')->where('course_id',$request->id)->where('student_id',$request->sid)->where('teacher_id',Auth::user()->id)->delete();
    ...
    public function editlession(Request $request)
    {
            ...
            return view('front.teacher.edit-lession',compact('lession'));
    }
    ...
    public function editlecture(Request $request)
    {
            ...
            return view('front.teacher.edit-lecture',compact('lecture'));
    }
    ...
    public function c_video(Request $request)
    {
        $id = $request->id;
        $t_courses = DB::table('courses')->where('id',$id)->first();
        return view('front.teacher.add-video',compact('t_courses','id'));
    }
    public function c_audio(Request $request)
    {
        $id = $request->id;
        $t_courses = DB::table('courses')->where('id',$id)->first();
        return view('front.teacher.add-audio',compact('t_courses','id'));
    }
    ...
    public function preview(Request $request)
    {
        ...
        return view('front.teacher.preview',compact('lession','id','chapture','course'));
    }
    ...
    public function dpresentation(Request $request){
        ...
        return view('front.teacher.my-docs',compact('presentation'));
    }
    ...
    public function dScrom(Request $request){
        ...
        return view('front.teacher.my-docs2',compact('presentation'));
    }
    ...
    public function dWeb(Request $request){
        ...
        return view('front.teacher.my-docs3',compact('presentation'));
    }
    ...
    public function gameCreate(Request $request)
    {
        ...
        try{
            ...
            // if(!isset($d12)){
                ...
                DB::table('course_games')->insert($data);
            // }else{
            //     $data = [
            //         'lession_id' => $request->input('lession'),
            //         'url' => $request->input('url'),
    ...
    public function preview1(Request $request)
    {
        ...
        return view('front.teacher.preview-game',compact('lession','course'));
    }
    ...
    public function editdata1(Request $request)
    {
            $id = $request->id;
            $iframe  = DB::table('course_games')->where('id',$id)->first();
            return view('front.teacher.edit-iframe',compact('iframe'));
    }
    public function updategame(Request $request)
    {
        ...
        try {
            ...
            DB::table('course_games')->where('id', $id)->update($data);
