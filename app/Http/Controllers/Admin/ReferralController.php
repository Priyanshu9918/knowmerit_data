...
class ReferralController extends Controller
{
        ...
        public function create(Request $request)
        {
            if ($request->isMethod('get')) {
                $referral = DB::table('referrals')->where('status',1)->get();
               return view('admin.referral.create',compact('referral'));
                }
        ...
        {
            $referral_id = base64_decode($request->id);

            if($request->isMethod('get'))
            {

                $referral  = DB::table('referrals')->where('id',$referral_id)->first();
            ...
            try{
                ...
                DB::table('referrals')->where('id',$referral_id)->update($data);
