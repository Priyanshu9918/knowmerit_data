...
class TestimonialController extends Controller
{
    public function index(Request $request){
        if($request->ajax())
        {
            ...
            ->editColumn('image', function ($row) {
                $image = url('/uploads/testimonial/'.$row->image);
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/testimonial/edit',['id'=>base64_encode($row->id)]);
    ...
    {
        $testimonials_id = base64_decode($request->id);

        if($request->isMethod('get'))
        {

            $testimonials  = DB::table('testimonials')->where('id',$testimonials_id)->first();
        ...
        try{
            ...
            if ($request->file('image')) {
                ...
                $final_image_name = $testimonials->image;
            }
            ...
            DB::table('testimonials')->where('id',$testimonials_id)->update($data);
