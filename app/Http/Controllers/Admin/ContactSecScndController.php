...
class ContactSecScndController extends Controller
{
        public function index(Request $request){
            if($request->ajax())
            {
                $role = DB::table('contact_sec_scnds')
                ...
                ->editColumn('one_image', function ($row) {
                    $one_image = url('/uploads/contact_sec_scnds/'.$row->one_image);
                ...
                ->addColumn('action', function($row) {
                    ...
                    $edit_url = url('/admin/contact_sec_scnds/edit',['id'=>base64_encode($row->id)]);
            ...
            return view('admin.contact_sec_scnds.index');
        }

        public function create(Request $request)
        {
            if ($request->isMethod('get')) {
                $contact_sec_scnds = DB::table('contact_sec_scnds')->where('status',1)->get();
               return view('admin.contact_sec_scnds.create',compact('contact_sec_scnds'));
                }
            ...
            try {
                ...
                if ($request->file('one_image')) {
                    ...
                    $destination_path = public_path('/uploads/contact_sec_scnds/');
                ...
                // dd($data);
                DB::table('contact_sec_scnds')->insert($data);
        ...
        {
            $contact_sec_scnds_id = base64_decode($request->id);

            if($request->isMethod('get'))
            {

                $contact_sec_scnds  = DB::table('contact_sec_scnds')->where('id',$contact_sec_scnds_id)->first();
                return view('admin.contact_sec_scnds.edit' ,compact('contact_sec_scnds'));
            }
            ...
            try{
                ...
                if ($request->file('one_image')) {
                    ...
                    $final_one_image_name = $contact_sec_scnds->one_image;
                }
                ...
                DB::table('contact_sec_scnds')->where('id',$contact_sec_scnds_id)->update($data);
