...
class ContactSecFstController extends Controller
{
        public function index(Request $request){
            if($request->ajax())
            {
                $role = DB::table('contact_sec_fsts')
                ...
                ->editColumn('one_image', function ($row) {
                    $one_image = url('/uploads/contact_sec_fsts/'.$row->one_image);
                ...
                ->addColumn('action', function($row) {
                    ...
                    $edit_url = url('/admin/contact_sec_fsts/edit',['id'=>base64_encode($row->id)]);
            ...
            return view('admin.contact_sec_fsts.index');
        }

        public function create(Request $request)
        {
            if ($request->isMethod('get')) {
                $contact_sec_fsts = DB::table('contact_sec_fsts')->where('status',1)->get();
               return view('admin.contact_sec_fsts.create',compact('contact_sec_fsts'));
                }
            ...
            try {
                ...
                if ($request->file('one_image')) {
                    ...
                    $destination_path = public_path('/uploads/contact_sec_fsts/');
                ...
                // dd($data);
                DB::table('contact_sec_fsts')->insert($data);
        ...
        {
            $contact_sec_fsts_id = base64_decode($request->id);

            if($request->isMethod('get'))
            {

                $contact_sec_fsts  = DB::table('contact_sec_fsts')->where('id',$contact_sec_fsts_id)->first();
                return view('admin.contact_sec_fsts.edit' ,compact('contact_sec_fsts'));
            }
            ...
            try{
                ...
                if ($request->file('one_image')) {
                    ...
                    $final_one_image_name = $contact_sec_fsts->one_image;
                }
                ...
                DB::table('contact_sec_fsts')->where('id',$contact_sec_fsts_id)->update($data);
