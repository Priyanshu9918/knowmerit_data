...
class WhyKnowMeritController extends Controller
{
        public function index(Request $request){
            if($request->ajax())
            {
                $role = DB::table('whyknowmerits')
                ...
                ->addColumn('action', function($row) {
                    ...
                    $edit_url = url('/admin/whyknowmerits/edit',['id'=>base64_encode($row->id)]);
            ...
            return view('admin.whyknowmerits.index');
        }

        public function create(Request $request)
        {
            if ($request->isMethod('get')) {
                $whyknowmerits = DB::table('whyknowmerits')->where('status',1)->get();
               return view('admin.whyknowmerits.create',compact('whyknowmerits'));
                }
            ...
            try {
                ...
                if ($request->file('two_image')) {
                    ...
                    $destination_path = public_path('/uploads/whyknowmerits/');
                ...
                // dd($data);
                DB::table('whyknowmerits')->insert($data);
        ...
        {
            $whyknowmerits_id = base64_decode($request->id);

            if($request->isMethod('get'))
            {

                $whyknowmerits  = DB::table('whyknowmerits')->where('id',$whyknowmerits_id)->first();
                return view('admin.whyknowmerits.edit' ,compact('whyknowmerits'));
            }
            ...
            try{
                ...
                if ($request->file('two_image')) {
                    ...
                    $final_two_image_name = $whyknowmerits->two_image;
                }
                if ($request->file('one_image')) {
                    ...
                    $final_one_image_name = $whyknowmerits->one_image;
                }
                ...
                DB::table('whyknowmerits')->where('id',$whyknowmerits_id)->update($data);
