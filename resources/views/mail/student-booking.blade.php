...
<tr>
    <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
        ...
        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #000; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
            You've successfully booked a class on KnowMerit. Here are the details:</p>
        </p>
        ...
        <p><span>Teacher</span> : {{$t_name}}</p>

        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #000; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
           <a href="{{$student_url}}"><button style=" padding: 10px 20px; border: none; border-radius: 7px; color: #fff;  background-color: #009fff; font-size: 16px; font-weight: 500;"> Join Here</button></a>
        </p>

        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #000; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
            We look forward to seeing you in class. If you need to cancel or have any questions, please contact our support team.</p>
        </p>
