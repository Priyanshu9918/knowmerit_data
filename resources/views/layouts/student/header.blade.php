            ...
            <div class="container">
                ...
                <div class="main-menu-wrapper">
                    ...
                    <ul class="nav header-navbar-rht align-items-center all-option-for-mobile-menu">
                        <li class="nav-item">
                            <img src="http://knowmerit.com/assets//img/my-img/web_img/coin-img12.png"
                                style="width: 22px;margin-right: 5px;margin-top: -4px;"><span
                                style="margin-left: 2px">0</span>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="teacher-mobile-menu">
                        <li><a href="{{ url('student/student-dashboard') }}" class="side-m"><i class="feather-user" aria-hidden="true" style="margin-right: 9px;"></i><span>My Dashboard</span></a></li>
                        {{-- <li><a href="#" class="side-m"><i class="feather-map-pin" style="margin-right: 9px;"></i>Location (Set Your
                            Location)</a></li> --}}
                        @if (!Auth::check())
                        ...
                        @endif
                        {{-- <li><a href="{{url('/trainer-list')}}" class="side-m"><i class="fa fa-user" aria-hidden="true" style="margin-right: 9px;"></i> Find a Tutor</a></li> --}}
                ...
                <ul class="nav header-navbar-rht align-items-center">
                    ...
                    <li class="nav-item headborder">
                      ...
                      @endphp
                        <a href="{{url('/chatify')}}"><img src="{{ asset('assets/img/icon/messages.svg') }}" alt="img">
                            <span class="badge badge-danger notification-v">{{$total_msg ?? 0}}</span>
                        </a>
                    </li>
                    @endif
                    <li class="nav-item headborder">
                        <div class="flag" style="width: 25px; height: 25px;">
                            @if(isset($c_name))
                            <span style="position:relative; left:-12px; top:-12px;"><x-dynamic-component component="flag-country-{{ strtolower($c_name) ?? 'in' }}" /></span>
                            @else
                            <span style="position:relative; left:-12px; top:-12px;"><x-dynamic-component component="flag-country-in" /></span>
                            @endif
                        </div>
                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end">
                                <div class="user-header">
                                    ...
                                    <div class="user-text">
                                        <h6>{{ Auth::user()->name ?? 'teacher' }}</h6>
                                        <p class="text-muted mb-0">Teacher</p>
                                    </div>
                                </div>
                                <a class="dropdown-item" href="{{ url('/teacher/teacher-profile') }}"><i
                            ...
                            <div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end">
                                <div class="user-header">
                                    <div class="avatar avatar-sm">
                                        ...
                                        @else
                                            <img src="{{ asset('assets/img/user/av.jpg') }}" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        @endif
                                    </div>
                                    <div class="user-text">
                                ...
                                <a class="dropdown-item" href="{{ url('/student/student-dashboard') }}"><i
                                        ...
                                        <a class="dropdown-item" href="{{ url('/student/student-profile') }}">
                                            <i class="fa fa-id-badge me-1"></i>My Profile</a>
                                            <!-- <a class="dropdown-item" href="{{ url('/student/question-list') }}"><i class="fa fa-cog"></i> &nbsp;Question Bank</a> -->
                                            <a class="dropdown-item" href="{{ url('/student/logout') }}"><i
                                        class="feather-log-out me-1"></i> Logout</a>
                            </div>
                        </li>
...
<div class="sidenav" id="mySidenav">
    ...
    {{-- <a href="#" class="side-m"><i class="feather-map-pin" style="margin-right: 9px;"></i>Location (Set Your
        Location)</a> --}}
    @if (!Auth::check())
