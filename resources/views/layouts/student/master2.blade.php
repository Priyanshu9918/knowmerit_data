        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content" style="height:365px;">
                ...
                <div class="modal-body" style="width: 100%">
                    <form action="{{ route('student.timezone.create') }}" method="POST" id="createFrm2222">
                        @csrf
                        <div class="container">
                            <label class="fw-bold">Country</label>
                            <select class="form-select country1" aria-label="Default select example" name="country1"
                                id="country_id1">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <div class="container d-none" id="tiz1">
                            <label class="fw-bold">TimeZone</label>
                            <select class="form-select" aria-label="Default select example" name="timezone1"
                                id="timezone_id1">
        ...
        $(document).on('change', '.country1', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $("#timezone_id1").empty();
                    $("#timezone_id1").html('<option value="">Select Timezone</option>');
                    $.each(data, function(key, value) {
                        $("#timezone_id1").append('<option value="' + value.id + '">' + value
                            .timezone + '</option>');
                    });
                    $('#tiz1').removeClass('d-none');
                }
            });
        });
