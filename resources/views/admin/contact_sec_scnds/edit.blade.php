                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.contact_sec_scnds.edit', ['id' => base64_encode($contact_sec_scnds->id)]) }}"
                                ...
                                <div class="row gx-3">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="title" type="text" value="{{ $contact_sec_scnds->title }}" id="title">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea id="mysummernote" class="form-control" id="description" name="description">{!! $contact_sec_scnds->description !!}</textarea>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="one_image" type="file" id="formFile"
                                                accept="image/*">
                                            @if ($contact_sec_scnds->one_image)
                                                <img class="mt-2 bg-danger"
                                                    src="{{ asset('uploads/contact_sec_scnds/' . $contact_sec_scnds->one_image) }}"
