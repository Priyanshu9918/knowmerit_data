...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            ...
            Add class
                        ...
                        <div>
                            <a href="{{route('admin.contact_sec_scnds.create')}}" class="btn btn-primary">Add Contact section</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="contact_sec_scnds-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th>Title</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#contact_sec_scnds-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#contact_sec_scnds-datatable').DataTable({

                    processing: true,

                    serverSide: true,

                    ajax: "{{route('admin.contact_sec_scnds')}}",
                ...
                $("#contact_sec_scnds-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#contact_sec_scnds-datatable').DataTable();
            ...
            $(document).on('click', '.statusBtn', function(event) {
                ...
                //  alert(user_id);
                var table = 'contact_sec_scnds';
                swal({
                        // icon: "warning",
                        type: "warning",
                        title: "Are you Want to Change The Status of This manage contact?",
                        text: "",
                        dangerMode: true,
