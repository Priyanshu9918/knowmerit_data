            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.featured.edit',['id'=>base64_encode($featureds->id)]) }}" method="POST" id="editFrm" enctype="multipart/form-data">
                                @csrf
                                <div class="row gx-3">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea  class="form-control"  id="description" name="description">{!! $featureds->description !!}</textarea>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == true) {
                            ...
                            //notify
                            toastr.success("Featureds Updated Successfully");
                            // Swal.fire({
                            // position: 'top-end',
                            // icon: 'success',
                            ...
                            window.setTimeout(function() {
                                window.location = "{{ url('/')}}" + "/admin/featured";
                            }, 2000);
