    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Featured List</h4>
                        <!-- <p class="card-description">
            Add class
            </p> -->
                        <div>
                            <a href="{{route('admin.featured.create')}}" class="btn btn-primary">Add Featured</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="featured-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th> Description</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#featured-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#featured-datatable').DataTable({

                    processing: true,

                    serverSide: true,

                    ajax: "{{route('admin.featured')}}",
                ...
                $("#featured-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#featured-datatable').DataTable();
            ...
            $(document).on('click', '.statusBtn', function(event) {
                ...
                swal({
                        // icon: "warning",
                        type: "warning",
                        title: "Are you Want to Change The Status of This manage slider?",
                        text: "",
                        dangerMode: true,
