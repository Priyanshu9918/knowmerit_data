    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">User Issue List</h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#category-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#category-datatable').DataTable({

                    processing: true,

                    serverSide: true,

                    ajax: "{{route('admin.issue')}}",
                ...
                $("#category-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#category-datatable').DataTable();
