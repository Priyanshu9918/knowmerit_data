                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.faq.edit', ['id' => base64_encode($faq->id)]) }}" method="POST"
                                    ...
                                    <!-- <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="f_type" name="f_type">
                                                ...
                                                <option value="0" @if($faq->f_type == '0')  selected @endif>Student</option>
                                                <option value="1"  @if($faq->f_type == '1')  selected @endif>Teacher</option>
                                            </select>
                                        </div>
                                     ...
                                     <div class="col-md-12">
                                         <div class="form-group ">
                                             <label class="col-sm-12 col-form-label"><b>Answer</b></label>
                                                 <textarea id="mysummernote" class="form-control "  placeholder="Answer" name="answer">{!! $faq->answer !!}</textarea>
