                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.contact_masters.edit', ['id' => base64_encode($contact_masters->id)]) }}"
                                ...
                                <div class="row gx-3">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="title" type="text" value="{{ $contact_masters->title }}" id="title">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea id="mysummernote" class="form-control" id="description" name="description">{!! $contact_masters->description !!}</textarea>
