...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            ...
            Add class
                        ...
                        <div>
                            <a href="{{route('admin.contact_masters.create')}}" class="btn btn-primary">Add Contact section</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="contact_masters-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th>Title</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#contact_masters-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#contact_masters-datatable').DataTable({

                    processing: true,

                    serverSide: true,

                    ajax: "{{route('admin.contact_masters')}}",
                ...
                $("#contact_masters-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#contact_masters-datatable').DataTable();
