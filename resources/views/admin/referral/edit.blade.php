                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.referral.edit', ['id' => base64_encode($referral->id)]) }}"
                                ...
                                <div class="row gx-3">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="title" type="text" value="{{ $referral->title }}" id="title">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea  class="form-control" id="short_description" name="short_description">{!! $referral->short_description !!}</textarea>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea id="mysummernote" class="form-control" id="description" name="description">{!! $referral->description !!}</textarea>
                                                <p style="margin-bottom: 2px;" class="text-danger error_container"
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.success == true) {
                                    ...
                                    //notify
                                    toastr.success("Referral Updated Successfully");
                                    // Swal.fire({
                                    // position: 'top-end',
                                    // icon: 'success',
