...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            ...
            Add class
                        ...
                        <div>
                            <a href="{{route('admin.referral.create')}}" class="btn btn-primary">Add Referral</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="referral-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th>Title</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#referral-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#referral-datatable').DataTable({
                ...
                $("#referral-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#referral-datatable').DataTable();
