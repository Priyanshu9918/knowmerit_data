                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.contact_headers.edit', ['id' => base64_encode($contact_headers->id)]) }}"
                                ...
                                <div class="row gx-3">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="title" type="text" value="{{ $contact_headers->title }}" id="title">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea id="mysummernote" class="form-control" id="description" name="description">{!! $contact_headers->description !!}</textarea>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="one_image" type="file" id="formFile"
                                                accept="image/*">
                                            @if ($contact_headers->one_image)
                                                <img class="mt-2 bg-danger"
                                                    src="{{ asset('uploads/contact_headers/' . $contact_headers->one_image) }}"
