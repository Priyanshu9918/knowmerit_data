                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" id ="summernote1" name="short_description" id="basic-icon-default-fullname"></textarea>
                                                <p style="margin-bottom: 2px;" class="text-danger error_container"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea class="" id ="summernote" name="long_description" ></textarea>
                                                <p style="margin-bottom: 2px;" class="text-danger error_container"
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12 text-center">
                                            <button type="submit" class="btn btn-primary submit mt-2">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
