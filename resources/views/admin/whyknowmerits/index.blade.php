...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Why Know Merit List</h4>
                        <!-- <p class="card-description">
            Add class
            </p> -->
                        <div>
                            <a href="{{route('admin.whyknowmerits.create')}}" class="btn btn-primary">Add Why Know Merit</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="whyknowmerits-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th>Title</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#whyknowmerits-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#whyknowmerits-datatable').DataTable({

                    processing: true,

                    serverSide: true,

                    ajax: "{{route('admin.whyknowmerits')}}",
                ...
                $("#whyknowmerits-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#whyknowmerits-datatable').DataTable();
            ...
            $(document).on('click', '.statusBtn', function(event) {
                ...
                //  alert(user_id);
                var table = 'whyknowmeritss';
                swal({
                        // icon: "warning",
                        type: "warning",
                        title: "Are you Want to Change The Status of This manage why know merit?",
                        text: "",
                        dangerMode: true,
