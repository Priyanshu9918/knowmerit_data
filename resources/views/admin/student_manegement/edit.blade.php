                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.student_manegment.edit', ['id' => base64_encode($user->id)]) }}"
                                        ...
                                        <div class="form-group ">
                                            ...
                                            @foreach ($parent_categories as $category)
                                                <input type="text" class="form-control category" id="category"
                                                    name="" value="{{ $category->name }}" readonly />
                                            @endforeach
                                            <input type="hidden" class="form-control category" id="category"
                                            ...
                                            <select class="form-control category" id="category" name="category">
                                                @foreach ($parent_categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        @if ($category->name == $user->category) selected @endif>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group ">
                                            ...
                                            @foreach ($parent_sub as $category)
                                                <input type="text" class="form-control sub_category" id="sub_category"
                                                    name="" value="{{ $category->name }}" readonly />
                                            @endforeach
                                            <input type="hidden" class="form-control sub_category" id="sub_category"
                                                name="sub_category" value="{{ $user->sub_category }}" />
                                            <p style="margin-bottom: 2px;" class="text-danger error_container"
                                        ...
                                        {{-- <div class="form-group ">
                                            ...
                                            <select class="form-control" name="sub_category" id="sub_category">
                                                ...
                                                @foreach ($category as $row)
                                                    @if (isset($user))
                                                        <option value="{{ $row->id }}"
                                                            @if ($row->id == $user->sub_category) selected @endif>
                                                            {{ $row->name }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success == true) {
                                ...
                                //notify
                                toastr.success("Demo Classes Updated Successfully");
