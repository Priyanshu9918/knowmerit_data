...
<div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
            <div class="card-body">
            <h4 class="card-title">Student Manegements List</h4>
            <!-- <p class="card-description">
            Add class
            </p> -->
            <div>
                <a href="{{route('admin.student_manegment.create')}}" class="btn btn-primary">Add Student Classes</a>
            </div>
    ...
    $(document).ready(function(){
        ...
        if ($("#user-datatable").length > 0) {
            ...
            var targetDt = $('#user-datatable').DataTable({
                ...
                ajax: "{{route('admin.student_manegment')}}",
                ...
                columns: [
                        ...
                        {data: 'classes_choice', name: 'classes_choice'},
        ...
        $(document).on('click', '.statusBtn', function (event) {
            ...
            //  alert(user_id);
            var table = 'book_a_classes';
            swal({
                // icon: "warning",
                type: "warning",
                title: "Are you Want to Change The Status of This Plan?",
                text: "",
                dangerMode: true,
