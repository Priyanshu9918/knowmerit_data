...
<div class="main-panel">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="enquiery-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th> Name</th>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p style="font-weight: bold; color: rebeccapurple;"><span class="enq-name"></span></p>
                <p style="font-weight: bold; color: rebeccapurple;"><span class="enq-email"></span></p>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <p><span class="enq-message"></span></p>
                    &nbsp;&nbsp;&nbsp;&nbsp;
              </div>
            </div>
          </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#enquiery-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#enquiery-datatable').DataTable({

                    processing: true,

                    serverSide: true,

                    ajax: "{{route('admin.enquiery')}}",
                ...
                $("#enquiery-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#enquiery-datatable').DataTable();
            ...
            $(document).on('click', '.statusBtn', function(event) {
                ...
                swal({
                        // icon: "warning",
                        type: "warning",
                        title: "Are you Want to Change The Status of This Enquiries?",
                        text: "",
                        dangerMode: true,
            ...
            $(document).on('click', '#View', function() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        console.log(data);
                        if (data.status == true) {
                            $('.enq-name').html('Name : '+data.fdata.name);
                            $('.enq-email').html('Email : '+data.fdata.email);
                            $('.enq-message').html(data.fdata.description);
