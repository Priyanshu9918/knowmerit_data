            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.manage-banner.edit',['id'=>base64_encode($manage_banners->id)]) }}" method="POST" id="editFrm" enctype="multipart/form-data">
                                @csrf
                                <div class="row gx-3">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea id="mysummernote" class="form-control"  id="description" name="description">{!! $manage_banners->description !!}</textarea>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="one_image" type="file" id="formFile"
                                                accept="image/*">
                                                @if ($manage_banners->one_image)
                                                <img class="mt-2" src="{{ asset('uploads/managebanner/' . $manage_banners->one_image) }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="formFile" class="form-label"><b>two Image</b></label>
                                            <input class="form-control" name="two_image" type="file" id="formFile"
                                                accept="image/*">
                                                @if ($manage_banners->two_image)
                                                <img class="mt-2" src="{{ asset('uploads/managebanner/' . $manage_banners->two_image) }}"
                                                    width="100px" height="70px" alt="img">
                                                  @endif
                                            <p style="margin-bottom: 2px;" class="text-danger error_container"
