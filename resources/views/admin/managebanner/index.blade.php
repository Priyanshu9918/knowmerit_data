...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            ...
            Add class
                        ...
                        <div>
                            <a href="{{route('admin.manage-banner.create')}}" class="btn btn-primary">Add Banner</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="manage_banner-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        {{-- <th>Description</th> --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#manage_banner-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#manage_banner-datatable').DataTable({
                ...
                $("#manage_banner-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#manage_banner-datatable').DataTable();
            ...
            $(document).on('click', '.statusBtn', function(event) {
                ...
                //  alert(user_id);
                var table = 'manage_banners';
                swal({
                        // icon: "warning",
                        type: "warning",
                        title: "Are you Want to Change The Status of This manage banner?",
                        text: "",
                        dangerMode: true,
