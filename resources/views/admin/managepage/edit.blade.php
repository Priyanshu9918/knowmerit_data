            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.manage-page.edit',['id'=>base64_encode($manage_pages->id)]) }}" method="POST" id="editFrm" enctype="multipart/form-data">
                                @csrf
                                <div class="row gx-3">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="name" type="text" id="name" value="{{$manage_pages->name}}">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea id="mysummernote" class="form-control"  id="description" name="description">{!! $manage_pages->description !!}</textarea>
                                                <p style="margin-bottom: 2px;" class="text-danger error_container"
