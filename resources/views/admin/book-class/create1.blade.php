                            ...
                            <form action="" method="POST" id="createFrm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <div class="col-sm-8">
                                                    <input type="hidden" id="category" name="category" value="{{ $cat->id }}">
                                                    <input type="hidden" id="sub_category" name="sub_category" value="{{ $sub_cat->id }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            <div class="col-lg-12 text-center">
                                                <button type="button"
                                                    class="btn btn-success mr-2 find_slot">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    @push('script')
        ...
        <script>
            $(document).ready(function() {
                ...
                //                 $("#sub_category").empty();
                //                 $("#sub_category").append(
                //                     '<option value="">No any Sub-category</option>');
                //             }
                //         }
                //     });
                // });
                ...
                //             if (data.success == false) {
                //                 $("#student").empty();
                //                 $("#student").append('<option value="">No any Student</option>');
                //             }
                //         }
                //     });
                // });
