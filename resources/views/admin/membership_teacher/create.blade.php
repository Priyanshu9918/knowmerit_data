    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Membership Teacher</h4>
                        <form action="{{ route('admin.membership-teacher.create') }}" method="POST" id="createFrm" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ">
                                        <label class="col-sm-12 col-form-label"><b>Content</b></label>
                                            <textarea id="mysummernote" class="form-control"  placeholder="content" name="content"></textarea>
