        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Membership Teacher List</h4>
                            <div>
                                <a href="{{ route('admin.membership-teacher.create') }}" class="btn btn-primary">Add Membership Teacher</a>
                                {{--<div class="btn-group">
                                    <select class="btn btn-primary" name="f_type" id="f_type">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped main" id="membership_teachers-datatable">
                                    <thead>
                                        <tr>
                                            <th> #</th>
                                            <th> Title</th>
    ...
    @push('script')
       <script>
           ...
           $(document).ready(function() {
                ...
                if ($("#membership_teachers-datatable").length > 0) {
                    /*Checkbox Add*/
                    var tdCnt = 0;
                    var targetDt = $('#membership_teachers-datatable').DataTable({
                        ...
                        ajax: "{{ route('admin.membership.teacher') }}",
                    ...
                    $("#membership_teachers-datatable").parent().addClass('table-responsive');

                    /*Select all using checkbox*/
                    var DT1 = $('#membership_teachers-datatable').DataTable();
                ...
                $(document).on('click', '.statusBtn', function(event) {
                    ...
                    //  alert(membership_teachers_id);
                    var table = 'membership_teachers';
                    swal({
                            // icon: "warning",
                            type: "warning",
                            title: "Are you Want to Change The Status of This faqs?",
                            text: "",
                            dangerMode: true,
