...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            ...
            Add class
                        ...
                        <div>
                            <a href="{{route('admin.community.create')}}" class="btn btn-primary">Add Community</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="community-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th> Community</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#community-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#community-datatable').DataTable({

                    processing: true,

                    serverSide: true,

                    ajax: "{{route('admin.community')}}",
                ...
                $("#community-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#community-datatable').DataTable();
            ...
            $(document).on('click', '.statusBtn', function(event) {
                ...
                swal({
                        // icon: "warning",
                        type: "warning",
                        title: "Are you Want to Change The Status of This community?",
                        text: "",
                        dangerMode: true,
