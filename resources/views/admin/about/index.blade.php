    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">AboutUs List</h4>
                        <!-- <p class="card-description">
            Add class
            </p> -->
                        <div>
                            <a href="{{route('admin.about-us.create')}}" class="btn btn-primary">Add AboutUs</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="about-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th> Title</th>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.statusBtn', function(event) {
                ...
                swal({
                        // icon: "warning",
                        type: "warning",
                        title: "Are you Want to Change The Status of This AboutUs?",
                        text: "",
                        dangerMode: true,
