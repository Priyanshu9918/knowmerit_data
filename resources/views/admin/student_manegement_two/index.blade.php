<style>
    ...
    width: 100vw;
    height: 100vh;
    background-color: #adaaaa59!important;
}
</style>
...
<div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div>
                <a href="{{route('admin.student_manegement_two.create')}}" class="btn btn-primary">Add Student Classes</a>
            </div>
    ...
    $(document).ready(function(){
        ...
        if ($("#user-datatable").length > 0) {
            ...
            var targetDt = $('#user-datatable').DataTable({
                ...
                ajax: "{{route('admin.student_manegement_two')}}",
