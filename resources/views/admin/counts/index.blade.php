...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Count List</h4>
                        <!-- <p class="card-description">
            Add class
            </p> -->
                        <div>
                            <a href="{{route('admin.count.create')}}" class="btn btn-primary">Add Count</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="count-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th>Count Name</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#count-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#count-datatable').DataTable({

                    processing: true,

                    serverSide: true,

                    ajax: "{{route('admin.count')}}",
                ...
                $("#count-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#count-datatable').DataTable();
            ...
            $(document).on('click', '.statusBtn', function(event) {
                ...
                //  alert(user_id);
                var table = 'count_dashboards';
                swal({
                        // icon: "warning",
                        type: "warning",
                        title: "Are you Want to Change The Status of This count?",
                        text: "",
                        dangerMode: true,
