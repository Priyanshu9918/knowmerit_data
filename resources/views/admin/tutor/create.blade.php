                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-sm-9 d-flex">
                                    ...
                                    <div class="form-check">
                                        <a href="{{ route('admin.institute.create') }}">
                                            <label class="radio-inline">
                                                <input type="radio" name="optradio"> <span style="color:#000">I run an
                                                    Institute</span>
                                            </label>
                                        </a>
                                    </div>
                            ...
                            <form action="{{ route('admin.tutor.create') }}" method="POST" id="createFrm"
                                    ...
                                    <div class="row gx-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="email" id="tutor_email"
                                                    name="tutor_email" placeholder="Enter Teacher email" />
                                                <p style="margin-bottom: 2px;" class="text-danger error_container"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="tel" class="form-control" id="tutor_mobile"
                                                        name="tutor_mobile" placeholder="Enter Teacher Mobile"
                                                        maxlength="10" />
                                                </div>
                                                <p style="margin-bottom: 2px;" class="text-danger error_container"
                                        ...
                                        <select class="form-control select select2" name="tutor_subject_teach[]" id="tutor_subject_teach" multiple>
                                            <option value="" disaled>Select Category</option>
                                            @foreach ($parent_categories as $cat)
                                            <option value="{{ $cat->id }}">{{ $cat->name }}</option>
                                            @endforeach
                                        </select>
                                        <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-tutor_subject_teach"></p>
                                    </div> --}}
                                    ...
                                    <div class="row gx-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select select2" name="language[]"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control mb-4" type="text" id="university_name"
                                                    name="university_name" placeholder="Enter School/University Name" />
                                        ...
                                        <div class="col-sm-6 d-none" id="y_n">
                                            <div class="form-group">
                                                <label class="add-course-label"><b>What is your Total experience (in
                                                    Years)?</b></label>
                                                <select class="form-control experience_year" name="experience_year"
                                                    id="experience_year">
                                                    <option value="">Select</option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="form-label"><b>How much do you charge per
                                                        hour?</b></label><br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="checkbox" name="classes_mode[]" value="Private Classes" id="private_classes">
                                                <p class="col-10">Group Classes</p>
                                                <input type="checkbox" name="classes_mode[]" value="Group Classes" id="group_classes">
                                            </div>
                                            <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-classes_mode"></p>
                                        </div>
                                    </div> --}}
                                        <div class="col-sm-6">
                                            <div class="form-group ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <input type="checkbox" name="conduct_mode_class[]"
                                                        value="Student Location" id="conduct_mode_class">
                                                    </div>
                                                    <div class="flex-design">
                                                    <p class="col-10">At My Location (Offline)</p>
                                                    <input type="checkbox" name="conduct_mode_class[]"
                                                        value="At My Location" id="conduct_mode_class">
                                                    </div>
                                                </div>
                                                <p style="margin-bottom: 2px;" class="text-danger error_container"
                                        ...
                                        <div class="col-sm-12 d-none" id="STATE1">
                                            <div class="form-group ">
                                                <label class="form-label"><b>Which of the following State Syllabus subjects
                                                        do you provide tuition for?*</b></label>
                                                @php
                                        ...
                                        <div class="col-sm-12 d-none" id="INT1">
                                            <div class="form-group ">
                                                <label class="form-label"><b>Which of the following International
                                                        Baccalaureate subjects do you provide tuition for?*</b></label>
                                                @php
                        ...
                        <div class="col-md-4">
                            ...
                            <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-payment_status">
                            </p>
                        </div>
                    </div>
        ...
        $('body').on('click', '.buy_now', function(e) {
            ...
            var options = {
                ...
                "handler": function(response) {
                    window.location.href = SITEURL + '/' + 'admin/paysuccessadminteacher?payment_id=' +
                        response
                        .razorpay_payment_id + '&amount=' + amount + '&name=' + name + '&mobile=' + mobile +
                        '&email=' + email + '&location=' + location +
                        '&language=' + language + '&image=' + image + '&degree=' + degree + '&gender=' +
                        gender + '&university_name=' + university_name +
