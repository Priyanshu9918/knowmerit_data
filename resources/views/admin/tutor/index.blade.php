            ...
            <div class="row">
                ...
                Add class
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="tutor-datatable">
                                    <thead>
                                        <tr>
                                            <th> #</th>
                                            <th> Name</th>
    ...
    @push('script')
        <script>
            $(document).ready(function() {
                ...
                if ($("#tutor-datatable").length > 0) {
                    /*Checkbox Add*/
                    var tdCnt = 0;
                    var targetDt = $('#tutor-datatable').DataTable({
                    ...
                    $("#tutor-datatable").parent().addClass('table-responsive');

                    /*Select all using checkbox*/
                    var DT1 = $('#tutor-datatable').DataTable();
                ...
                $(document).on('click', '.featuredBtn', function(event) {
                    ...
                    swal({
                            // icon: "warning",
                            type: "warning",
                            title: "Are you Want to Enable The Status of This tutor?",
                            text: "",
                            dangerMode: true,
                ...
                $(document).on('click', '.statusBtn', function(event) {
                    ...
                    swal({
                            // icon: "warning",
                            type: "warning",
                            title: "Are you Want to Change The Status of This tutor?",
                            text: "",
                            dangerMode: true,
                            showCancelButton: true,
                            confirmButtonColor: "#007358",
                ...
                $(document).on('click', '.featuredBtn1', function(event) {
                    ...
                    swal({
                        ...
                        function(e) {
                            if (e == true) {
                                $.ajax({
                                    type: 'POST',
                                    url: "{{ route('admin.enable-action1') }}",
                                    data: {
                                        "_token": "{{ csrf_token() }}",
                                        'id': id,
                                        'table_name': table,
