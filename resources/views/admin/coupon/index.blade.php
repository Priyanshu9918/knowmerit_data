                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <a href="{{ url('/admin/coupons/create')}}" class="btn btn-primary">Add Coupon</a>
                                {{--<div class="btn-group">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped main" id="faq-datatable">
                                    <thead>
                                        <tr>
                                            <th>S.No</th>
											<th>Code Name </th>
                ...
                if ($("#faq-datatable").length > 0) {
                    ...
                    var targetDt = $('#faq-datatable').DataTable({
                        ...
                        columns: [
                            ...
                            {data: 'expiry_date_time', name: 'expiry_date_time'},
