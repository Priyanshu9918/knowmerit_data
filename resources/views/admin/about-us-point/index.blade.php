...
<div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
            <div class="card-body">
            <h4 class="card-title">About Us Point List</h4>
            <div>
                <a href="{{route('admin.aboutus-point.create')}}" class="btn btn-primary">Add About Us Point</a>
            </div>
            <div class="table-responsive">
            <table class="table table-striped" id="about-us-point-datatable">
                <thead>
                <tr>
                    <th> #</th>
                    <th> title</th>
...
<script>
    $(document).ready(function(){
        ...
        if ($("#about-us-point-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#about-us-point-datatable').DataTable({

                processing: true,

                serverSide: true,

                ajax: "{{route('admin.aboutus-point')}}",
            ...
            $("#about-us-point-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#about-us-point-datatable').DataTable();
