    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Write A Review List</h4>
                        <!-- <p class="card-description">
            Add class
            </p> -->
                        <div>
                            {{-- <a href="{{route('admin.review.create')}}" class="btn btn-primary">Add review</a> --}}
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="review-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th> Tutor Type</th>
        ...
        $(document).ready(function() {
            ...
            if ($("#review-datatable").length > 0) {
                ...
                var targetDt = $('#review-datatable').DataTable({
                    ...
                    ajax: "{{route('admin.write-a-review')}}",
            ...
            $(document).on('click', '.statusBtn', function(event) {
                ...
                //  alert(user_id);
                var table = 'write_reviews';
                swal({
                        // icon: "warning",
                        type: "warning",
                        title: "Are you Want to Change The Status of This review?",
                        text: "",
                        dangerMode: true,
