...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            ...
            Add class
                        ...
                        <div>
                            <a href="{{route('admin.mcq.create')}}" class="btn btn-primary">Add MCQs</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped" id="mcq-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th>Category</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#mcq-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#mcq-datatable').DataTable({

                    processing: true,

                    serverSide: true,

                    ajax: "{{route('admin.mcq')}}",
                ...
                $("#mcq-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#mcq-datatable').DataTable();
