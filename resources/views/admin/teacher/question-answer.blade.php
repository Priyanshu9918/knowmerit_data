...
@section('content')
    <style type="text/css">
        ...
        #add-deail-question1 .modal-dialog {
            max-width: 1300px;
        }
            ...
            <div class="row">
                <div class="row" style="background-color: #4f94cf12; border-radius: 10px;">
                    ...
                    <div>
                        ...
                        <input type="hidden" id="tid" value="{{request()->tid}}">
                        @php
                            $welcome = DB::table('welcome_pages')
                                ->where('u_id', $u_id)
                                ->first();
                        @endphp
                        @if (isset($welcome))
                        ...
                        @foreach ($qa_page as $key => $qa)
                            <div class="add-question-block mt-3">
                                <div class="panel-head add-block">
                                    ...
                                    <div class="head-icon">
                                        <!-- <i class="fa fa-pencil-square-o" aria-hidden="true"></i> -->
                                        <i class="fa fa-times" aria-hidden="true" id="deleteq1"
                                            data-id="{{ $qa->id }}"></i>
                                    </div>
                                </div>
                                @php
                                    $questions = DB::table('choice_questions')
                                        ->where('u_id', $u_id)
                                        ->where('page', $qa->page_no)
                                        ->get();
                                @endphp
                                    ...
                                    @if ($ques->type == 'single_choice_radio')
                                        <div class="questions btmborder foriconscls">
                                            <div class="edit-cancel-question">
                                                <i class="fa fa-pencil-square-o" id="edit-question" aria-hidden="true"
                                                    data-id="{{ $ques->id }}"></i>
                                                <i class="fa fa-times" aria-hidden="true" id="deleteq"
                                                    data-id="{{ $ques->id }}"></i>
                                            </div>
                                                ...
                                                @foreach ($option as $op1)
                                                    <div class="col-md-6">
                                                        <label class="quesoptiondes"><i class="fa fa-circle-o unchk"
                                                                aria-hidden="true"></i>
                                                            <input type="radio" name="sdvbnm" value="1"
                                                                class="quesoptiondesin" required
                                            ...
                                            <div class="row">
                                                ...
                                                @foreach ($option2 as $op13)
                                                    <div class="col-md-6">
                                                        ...
                                                        <label class="multiquesoptiondes"><i class="fa fa-square-o unchk"
                                                                aria-hidden="true"></i>
                                                            <input type="checkbox" name="sdvbnm" value="1"
                                                                class="multi-question" required
                                    ...
                                    @else
                                        <div class="questions btmborder foriconscls">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"><select class="form-control" id="category"
                                                        name="category">
                                                        <option value="">Select option</option>
                                                        @foreach ($option1 as $key => $op11)
                                                            <option value="{{ $key++ }}">{!! $op11 !!}
                                                            </option>
                                                        @endforeach
                                                    </select></div>
                                            </div>
                            ...
                            <div class="questions btmborder foriconscls">
                                <div class="edit-cancel-question">
                                    ...
                                    <label class="all-ques-label-des">{!!$ckecl->question!!}</label>
                            ...
                            <div class="questions btmborder foriconscls">
                                ...
                                <label class="all-ques-label-des">{!!$drop->question!!}</label>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a id="contact" data-page="{{ $qa->page_no }}" class="dropdown-item"
                                                    href="#">Question</a></li>
                        ...
                        <div class="add-new-block">
                            <div class="btn-group">
                                ...
                                &nbsp;&nbsp;
                                @php
                                    $dat1 = DB::table('choice_questions')
                                        ->where('u_id', $u_id)
                                        ->get();
                                @endphp
                                @if (count($dat1) > 0)
                                ...
                                @endif
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="javascript:void(0)" id="q_page">Quiz Page</a>
                                    </li>
                                    <li><a class="dropdown-item" href="javascript:void" id="wlcom">Welcome Page</a>
                                    </li>
                    ...
                    <div id="contactForm">
                        <div class="modal-form-des">
                            ...
                            <form action="{{ route('admin.teacher.single_choice.create') }}" method="POST" id="createFrm12"
                                ...
                                <div class="popup-add">
                                    ...
                                    <div class="form-group" id="dialogQuestionTextArea">
                                        ...
                                        <textarea tabindex="2" class="form-control" id="dialogQuestionText" rows="3" name="question"></textarea>
                                        <p style="margin-bottom: 2px;" class="text-danger error_container"
                                            id="error-question"></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="text-coorect-option">
                                            <textarea tabindex="2" class="form-control" id="dialogQuestionText0" rows="3" name="option[]"></textarea>
                                            <div class="correc">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5>Welcome Page</h5>
                                    <button id="cancel-btn" type="button" class="close"
                                        data-dismiss="modal">&times;</button>
                                </div>
                                <div class="modal-body">
                                    <form action="{{ route('admin.teacher.welcome.create') }}" method="POST" id="createFrm"
                                        enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="popup-add">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="welcome_text" id="overview" rows="5"></textarea>
                                                <p style="margin-bottom: 2px;" class="text-danger error_container"
                                                    id="error-welcome_text">
                                                </p>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <button id="deail-question-cancel-btn" type="button" class="close"
                                        data-dismiss="modal">&times;</button>
                                </div>
                                <form action="{{ route('admin.teacher.student.assign') }}" method="POST" id="createFrm222"
                                    enctype="multipart/form-data">
                                                ...
                                                <select name="student">
                                                    @if (count($student_enquiry1) > 0)
                                                        ...
                                                        @foreach ($student_enquiry1 as $st1)
                                                            ...
                                                            @endphp
                                                            @if (isset($data->name))
                                                                <option value="{{ $st1->student_id }}">{{ $data->name }}
                                                                </option>
                                                            @endif
                                                        @endforeach
                                                    @else
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '#add1', function() {
                    ...
                    $("#mt12").append(`<div class="text-coorect-option" id="row${i}">
                                    <textarea tabindex="2" class="form-control" id="dialogQuestionText${i}" rows="3" name="option[]"></textarea>
                                    <div class="correc">
                ...
                $(document).on('click', '#edit1', function() {
                    ...
                    $("#mt13").append(`<div class="text-coorect-option1" id="row${i}">
                            <textarea tabindex="2" class="form-control" id='dialogQuestionText111${i}' rows="3" name="option[]"></textarea>
                                    <div class="correc">
                ...
                $(document).on('click', '#q_page', function() {
                    ...
                    $.ajax({
                        url: "{{ route('admin.teacher.q_page') }}",
                        type: 'GET',
                        data: {
                            u_id: u_id,
                        },
                ...
                $(document).on('click', '#deleteq', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var ajaxUrl = "{{ route('admin.teacher.delete-question') }}";
                            var requestData = {
                                "_token": "{{ csrf_token() }}",
                                'id': id,
                            };
                ...
                $(document).on('click', '#deleteq1', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            // User confirmed, make your AJAX request here to delete the account
                            var ajaxUrl = "{{ route('admin.teacher.delete-page') }}";
                            var requestData = {
                                "_token": "{{ csrf_token() }}",
                                'id': id,
                            };
