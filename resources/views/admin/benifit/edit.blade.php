            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.benifit.edit',['id'=>base64_encode($user->id)]) }}" method="POST" id="createFrm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <option value="">Select</option>
                                                ...
                                                <option value="{{$cat->id}}" @if($cat->id==$user->m_id) selected @endif>{{$cat->name}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" id="summernote" name="benifits" value="">{!! $user->benifits !!}</textarea>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == true) {
                            ...
                            //notify
                            toastr.success("Benifits Updated Successfully");
