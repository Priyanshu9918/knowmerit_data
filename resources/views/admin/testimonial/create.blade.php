            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.testimonial.create') }}" method="POST" id="createFrm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-location"></p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label"><b>Rating</b></label>
                                        <input class="form-control" type="text" name="rating" placeholder="Enter testimonial rating" />
