...
<div class="main-panel">
        ...
        <div class="row">
            ...
            Add class
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="testimonial-datatable">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        <th> Name</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#testimonial-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#testimonial-datatable').DataTable({
                ...
                $("#testimonial-datatable").parent().addClass('table-responsive');

                /*Select all using checkbox*/
                var DT1 = $('#testimonial-datatable').DataTable();
