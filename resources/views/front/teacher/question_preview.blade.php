...
<div class="col-xl-9 col-lg-8 col-md-12 p-4 " style="background-color: #4f94cf12; border-radius: 10px;">
 ...
 <!--    <div class="profile-title for-quespretext">
                    ...
                    @foreach($option as $op1)
                        ...
                        <div class="col-md-6">
                            <label class="quesoptiondes"><i class="fa fa-circle-o unchk" aria-hidden="true"></i>
                                <input type="radio" name="sdvbnm" class="quesoptiondesin" value="1" required="" style="display: none;" >
                            {!!$op1!!}
                        </label>
                        </div>
                        @endforeach
        ...
        <div class="forcheckicons-parent">
            <div class="questions forcheckicons">
                ...
                <label class="all-ques-label-des">{{$key+1}}. &nbsp; {!!$drop->question!!}</label>
                    <div class="row">
            ...
                                  
                                  <label  class="quesoptiondes"><i class="fa fa-circle-o unchk" aria-hidden="true"></i>
                                    <input type="checkbox" name="sdvbnm" value="1" class="quesoptiondesin"  required="" style="display: none;" >  {!!$op13!!}
                                </label>
                            </div>
                            @endforeach
                    </div>
        ...
        <div class="forcheckicons-parent">
            <div class="questions forcheckicons">
                ...
                <label class="all-ques-label-des">{{$key+1}}. &nbsp;{!!$drop1->question!!}</label>
        ...
        <div class="question-number">
            <ul>
                ...
                @foreach($page_no as $key=>$pag)
                    <a href="{{ route('teacher.question-preview',['id'=>base64_encode($u_id),'page'=>$pag->page]) }}"><li>{{$pag->page}}</li></a>
                @endforeach
            </ul>
        </div>
