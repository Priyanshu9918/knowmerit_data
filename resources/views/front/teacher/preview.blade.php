...
$presentaion = DB::table('course_presentations')->where('lession_id',$lession->id)->orderBy('created_at','desc')->get();
...
<div class="profile-title" style="background-color:#009FFF;">
    <h3 class="mb-0 text-white text-uppercase"><a href="{{ URL::previous() }}">
                            ...
                            @if(count($video11) > 0)
                                ...
                                <ul class="collapse" id="exam2">
                                  ...
                                  @if(count($Quiz) > 0)
                                      ...
                                      @php
                                        $q_id_ui = base64_encode($Quizs->u_id);
                                      @endphp
                                      <li>
                                        <a href="/teacher/question-preview/{{ base64_encode($Quizs->u_id) }}?page=1" target="_blank">
                                            ...
                                            <i class="fa fa-times" style="padding: 15px; color:red;"></i> </a>
                                            <a href="{{ url('/teacher/question-answer/' . $q_id_ui) . '?course_id=' . $lession->id }}" target="_blank">
                                            <i class="fa fa-edit" style="padding: 15px; color:green;"></i> </a>
                                            <a href="javascript:void(0)" data-bs-toggle="collapse" id="edit_quiz" data-type="quiz" data-id="{{$Quizs->id}}">
                                            <i class="fa fa-pencil" style="padding: 15px; color:green;"></i> </a>
                                      </li>
                                      @endforeach
                                  @endif
                                  @if(count($Web) > 0)
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="popup-add">
                    <form action="{{route('teacher.update-video')}}" method="POST" id="editvideo" enctype="multipart/form-data">
                        @csrf
...
<div id="data-audio-view" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="popup-add">
                    <form action="{{route('teacher.update-audio')}}" method="POST" id="editaudio" enctype="multipart/form-data">
                        @csrf
...
<div id="iframe_view" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="popup-add">
                    <form action="{{route('teacher.update-iframe')}}" method="POST" id="editiframe" enctype="multipart/form-data">
                        @csrf
...
<div id="Presentation123" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="popup-add">
                    <form action="{{route('teacher.update-presentation')}}" method="POST" id="editpresentation" enctype="multipart/form-data">
                        @csrf
...
<div id="Assign123" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="popup-add">
                    <form action="{{route('teacher.update-assign')}}" method="POST" id="editassign" enctype="multipart/form-data">
                        @csrf
...
<div id="scrom_view" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="popup-add">
                        <form action="{{route('teacher.update-scrom')}}" method="POST" id="editscrom" enctype="multipart/form-data">
                                @csrf
...
<div id="Quiz" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="popup-add">
                        <form action="{{route('teacher.update-quiz')}}" method="POST" id="editquiz" enctype="multipart/form-data">
                                @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" style="height: 640px;">
                    <div class="popup-add">
                    <form action="{{route('teacher.update-web')}}" method="POST" id="editweb" enctype="multipart/form-data">
                        @csrf
                        <div id="web-data"></div>
                    </form>
                    </div>
...
$(document).ready(function() {
            ...
            $(document).on('click', '#edit_presentation', function(event) {
                ...
                var type = $(this).attr('data-type');
                $.ajax({
                    url: "{{ route('teacher.edit-presentation') }}",
                    type: "get",
                    data: {
                        'id': id,
                        'type': type,
    ...
    $(document).on('click', '#view_presentation', function(event) {
        ...
        var id = $(this).attr('data-id');
        $.ajax({
            url: "{{ route('teacher.d-presentation') }}",
            type: "get",
            data: {
                'id': id,
            },
