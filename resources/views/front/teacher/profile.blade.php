...
<div class="col-xl-9 col-lg-8 col-md-12">
    ...
    <div class="row forcont p-3" style="background-color: #4f94cf12; border-radius: 10px;">
        <section class="page-content course-sec p-0 mt-4 mb-4">
            <div class="container">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select select2"
                                                                    name="language[]" id="language112" multiple>
                                                                    <option value="" disabled>Select</option>
                                            ...
                                            <div class="add-course-form">
                                                ...
                                                Classes
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="conduct_mode_class[]"
                                                                value="Student Location" class="op1"
                                                                {{ in_array('Student Location', $conduct_mode) ? 'checked' : '' }}>Student
                                                            Location (Offline)
                                                        </label><br>
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="conduct_mode_class[]"
                                                                value="At My Location" class="op1"
                                                                {{ in_array('At My Location', $conduct_mode) ? 'checked' : '' }}>At
                                                            My Location (Offline)
                                                        </label>
                                                        <p style="margin-bottom: 2px;" class="text-danger error_container"
