                                ...
                                <div class="col-lg-12 d-flex">
                                    <div class="instructor-list flex-fill">
                                        ...
                                        {{-- <div class="instructor-content">
                                            <h5><a
                                                    href="{{ url('/instructor-profile', ['id' => $row->id]) }}">{{ $row->name }}</a>
                                            </h5>
                                            <h6>Instructor</h6>
                                            <div class="instructor-info">
                                                ...
                                                <a href="#rate" class="rating-count"><i
                                        ...
                                        <div class="instructor-content">
                                            ...
                                            @if ($row->youtube_url != '')
                                                <div class="watch-video-block">
                                                    <button data-url="{{ $row->youtube_url }}" id="watch-videos">Watch
                                                        Video</button>
                                                </div>
                                            @endif
                                            <div class="featured-info-time d-flex align-items-center">
            ...
            <div class="modal-content" style="border-radius: 10px 10px 10px 10px;">
                ...
                <div class="modal-body">
                    <div>
                        ...
                        <iframe class="tube" id="ytube" width="100%" height="460" src=""
