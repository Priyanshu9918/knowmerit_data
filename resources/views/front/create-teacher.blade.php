            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="widget-set" id="div2">
                            <h5 class="select-tech1">I am an Individual</h5>
                                ...
                                <fieldset id="first">
                                    <div class="add-course-info">
                                        ...
                                        <div class="add-course-form">
                                            <form action="{{ route('front.tutor.create') }}" method="POST" id="createFrm"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select" name="tutor_gender"
                                                                    id="tutor_gender">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="add-course-label">Mobile</label>
                                                        ...
                                                        {{-- <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="add-course-label">Teach Subject</label>
                                                                <select class="form-control select2"
                                                                    name="tutor_subject_teach[]" id="tutor_subject_teach"
                                                                    multiple>
                                    ...
                                    <div class="add-course-info">
                                        ...
                                        <div class="add-course-form">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 d-none" id="ye_n" >
                                                    <div class="form-group">
                                                        <label class="add-course-label">What is your Total experience (in Years)?</label>
                                                        <select class="form-control select experience_year" name="experience_year" id="experience_year">
                                                            <option value="">Select</option>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" name="conduct_mode_class[]" value="Online"
                                                            class="op1">Online (Remote)
                                                    </label><br>
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" name="conduct_mode_class[]"
                                                            value="Student Location" class="op1">Student Location
                                                        (Offline)
                                                    </label><br>
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" name="conduct_mode_class[]"
                                                            value="At My Location" class="op1">At My Location (Offline)
                                                    </label>
                                                    <p style="margin-bottom: 2px;" class="text-danger error_container"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6" id="p_l">
                                                    <div class="widget-btn">
                                                        ...
                                                        <button type="submit" class="btn btn-info-light submit">Pay
                                                            later</button>
                                                    </div>
                                                </div>
                                                </form>
...
@push('script')
        ...
        $('body').on('click', '.buy_now', function(e) {
            ...
            var options = {
                ...
                "handler": function(response) {
                    window.location.href = SITEURL + '/' + 'paysuccessteacher?payment_id=' + response
                        .razorpay_payment_id + '&amount=' + amount + '&name=' + name + '&mobile=' + mobile +
                        '&email=' + email + '&category=' + category + '&location=' + location +'&sub_category=' + sub_category +
                        ...
                        all_inter_subject + '&lng=' + lng + '&lat=' + lat +
    ...
    <script>
        $(document).on('change', '#teaching_experience', function() {
            ...
            if (experience === "Yes") {
                $("#ye_n").removeClass('d-none'); // Show the div
            } else {
                $("#ye_n").addClass('d-none'); // Hide the div
            }
        });
        $(document).ready(function() {
