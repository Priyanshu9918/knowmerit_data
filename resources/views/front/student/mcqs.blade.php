   ...
   .dash-table td {
		padding: 1rem 35px!important;
         ...
         <div class="col-xl-9 col-lg-8 col-md-12">
			<h3> MCQs  </h3>
         <form action="{{ route('student.mcq.create') }}" method="POST" id="createFrm" enctype="multipart/form-data">
            @csrf
                  ...
                  @if(count($mcq)>0)
                     ...
                     <div class="questions btmborder">
                        ...
                        <input type="hidden" name="mcq_id[]" value="{{$mcqs->id}}">
                           <div class="">
                                  <input type="radio" name="ans[{{$mcqs->id}}]" value="1" required>
                                  <label for="">{{$mcqs->ans1 ?? ''}}</label>
                           </div>
                           <div class="">
                                  <input type="radio" name="ans[{{$mcqs->id}}]" value="2" required>
                                  <label for="">{{$mcqs->ans2 ?? ''}}</label>
                           </div>
                           <div class="">
                                  <input type="radio" name="ans[{{$mcqs->id}}]" value="3" required>
                                  <label for="">{{$mcqs->ans3 ?? ''}}</label>
                           </div>
                              <div class="">
                                  <input type="radio" name="ans[{{$mcqs->id}}]" value="4" required>
