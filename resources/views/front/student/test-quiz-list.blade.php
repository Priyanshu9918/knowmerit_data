...
<div class="col-xl-9 col-lg-8 col-md-12" style="background-color: #4f94cf12; border-radius: 10px;">
    ...
    <div>
        @php
            $choise = DB::table('student_questions')->where('student_id',Auth::user()->id)->where('u_id',request()->id)->get();
                ...
                <div class="comman-space p-0">
                    <div class="settings-referral-blk course-instruct-blk  table-responsive">
                        <table class="table table-nowrap mb-0 quiz-table-des">
                            ...
                            @php
                                $quiz_list2 = DB::table('choice_questions')->where('u_id',$listq->u_id)->first();
                            @endphp
                            <tbody>
                                @if($quiz_list2->course_id != null)
                                <tr>
                                    <td><a href="javascript:void(0)">Test Quiz{{$key+1}}</a></td>
