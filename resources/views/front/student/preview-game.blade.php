...
.page-content.instructor-page-content.createstudent {
...
<div class="profile-title" style="background-color:#009FFF;">
    <h3 class="mb-0 text-white text-uppercase"><a href="{{ url('/student/course-details1/'.$course->id) }}">
